...
const NavIconMove = () => {
  ...
  return (
    <div className=" h-[200vh]">
      <nav className=" flex justify-between items-center p-5 text-xl fixed left-[256px] top-0 z-[1000] bg-black text-primary right-0">
      ...
      <div className=" logo_container">
        <h1 className="logo font-spicy fixed top-4 text-4xl text-primary left-[53%] transform translate-x-[50%] z-[1000]">
          GSAP
        </h1>
      </div>
